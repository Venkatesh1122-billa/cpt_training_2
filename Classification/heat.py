...
print(f" Prediction of new student(hours = 5, score = 70):{'Pass' if prediction[0]==1 else 'Fail'}")
plt.figure(figsize = (10,6))
scatter = sns.scatterplot(x = 'hours', y = 'score', hue = 'pass', style = 'pass', size = 'pass', palette = 'hot', sizes = (50,150), data = df)

x_min, x_max = x['hours'].min()-1, x['hours'].max()+1
y_min, y_max = x['score'].min()-5, x['score'].max()+5
